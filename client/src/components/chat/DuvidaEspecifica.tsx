...
const DuvidaEspecifica = () => {
  ...
  useEffect(() => {
    api
      .get(`/community/duvidas?id_duvida=${id}`)
      .then((res) => {
        console.log(res);
      })
      .catch((err: Error) => {
    ...
    <div className={styles.duvidaEspecifica}>
      <div className={styles.cabecalho}>
        ...
        <div className={styles.direita}>
          <span className={styles.visto}>Visto</span>
      ...
      <section className={styles.duvida}>
        <h1>Código JavaScript sem funcionar</h1>

        <p>
          Fiz uma estrutura básica de loop e meu código não está funcionando.
          Abaixo deixarei a imagem anexada com o código.
        </p>
