...
const reorder = (
  list: Array<TypeLinhas> | ArrayLike<TypeLinhas>,
  startIndex: number,
  endIndex: number
) => {
  ...
  return (
    <div className={styles.ordenacao}>
      <div className={styles.conteudo}>
        ...
        {fim ? (
          <>
            <Acertos acertos={acertos} quantidadeQuestoes={questoes.length} />
            ...
            <section>
              ...
              <div className={styles.botoes}>
                ...
                {linhas.length - 2 == fase ? (
                  <button onClick={verificar}>FINALIZAR</button>
                ) : (
